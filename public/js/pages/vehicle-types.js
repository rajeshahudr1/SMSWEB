...
function renderImportResults(results) {
    ...
    var h = '<table class="table table-sm table-bordered mb-0"><thead><tr><th style="width:30px;">#</th><th>Vehicle Type</th><th style="width:80px;">Status</th><th>Error</th><th style="width:110px;">Action</th></tr></thead><tbody>';
...
function retryImportRow(idx) {
    ...
    $.post(BASE_URL + '/vehicle-types/import/single', { part_name: newName, image_url: (r.data && r.data['image url']) || '' }, function(res) {
