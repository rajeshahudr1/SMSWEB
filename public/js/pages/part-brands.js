...
function retryImportRow(idx) {
    ...
    $.post(BASE_URL + '/part-brands/import/single', { name: newName, image_url: (r.data && r.data['image url']) || '' }, function(res) {
