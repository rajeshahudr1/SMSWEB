    ...
    $.post(BASE_URL+'/vehicle-fuels/paginate',_filters(),function(res){
        ...
        data.forEach(function(r,i){
            ...
            if(deleted){
                ...
                if(editable)acts+='<a href="'+BASE_URL+'/vehicle-fuels/'+r.uuid+'/edit" class="btn btn-ghost-secondary" title="'+T('btn.edit','Edit')+'"><i class="bi bi-pencil"></i></a>';
...
function renderImportResults(results) {
    ...
    var h = '<table class="table table-sm table-bordered mb-0"><thead><tr><th style="width:30px;">#</th><th> Fuels</th><th style="width:80px;">Status</th><th>Error</th><th style="width:110px;">Action</th></tr></thead><tbody>';
...
function retryImportRow(idx) {
    ...
    $.post(BASE_URL + '/vehicle-fuels/import/single', { part_name: newName, image_url: (r.data && r.data['image url']) || '' }, function(res) {
